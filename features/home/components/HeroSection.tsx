  ...
  return (
    <section className="relative min-h-dvh flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full min-h-dvh flex items-center justify-center p-4 sm:p-8 md:p-12 lg:p-20">
        <div className="absolute inset-4 sm:inset-8 md:inset-12 lg:inset-20 border border-white/40 pointer-events-none" />

        <Container className="flex flex-col items-center justify-center text-center">
          <div className="max-w-4xl w-full">
            {/* Headline */}
            <div className="flex flex-col items-center justify-center text-center">
              <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl font-medium leading-none tracking-tight text-white">
                Né de Madagascar,
                <br />
                fait pour le monde.
              </h1>
            ...
            <div className="mt-6 md:mt-8 flex flex-col items-center justify-center text-center">
              <p className="font-sans text-base sm:text-lg text-zinc-200 leading-relaxed max-w-2xl px-4">
